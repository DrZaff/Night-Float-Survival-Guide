...
function wireButtonDropdowns(root) {
  // Support legacy/manual dropdown markup using <button class="drop-btn"> + <div class="drop-panel">
  const buttons = Array.from(root.querySelectorAll("button.drop-btn"));
  buttons.forEach((btn) => {
...
document.addEventListener("DOMContentLoaded", init);function pushCurrentView() {
...
/* ---- Footer credit injection (non-destructive) ---- */
